...
s`ShimLabel := "194.1-[1,2,97,194]";

s`ShimDiscriminant :=  194;
s`ShimLevel :=  1;
s`ShimAtkinLehner :=  [ 1, 2, 97, 194 ];
s`ShimGenus :=  0;
...
x[1]^2*x[3]^22,
1/2*x[1]^3*x[3]^21 + 1/2*x[1]^2*x[3]^22 - 1/2*x[1]*x[3]^23,
1/4*x[1]^4*x[3]^20 + 1/2*x[1]^3*x[3]^21 - 1/4*x[1]^2*x[3]^22 - 1/2*x[1]*x[3]^23 + 1/4*x[3]^24
] >;
