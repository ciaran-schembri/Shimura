...
s`ShimModel := HyperellipticCurve([Polynomial([RationalField() | -43, -159, -41, -37, -152, -80]), Polynomial([RationalField() |])]);
...
-1/8*x[1]^2*x[2]*x[3]^24 - 1/8*x[2]*x[3]^26,
-1/2*x[1]^4*x[3]^8 - x[1]^2*x[3]^10 - 1/2*x[3]^12
] >;
