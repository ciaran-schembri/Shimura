...
34,
1,
[3*x^4-26*x^3+53*x^2+26*x+3+y^2],
< <2,"[-1/x,y/x^2]">, <17,"[-1/x,-y/x^2]"> >,
34
>,
<
46,
...
82,
1,
[-y1^2 + 16*x1^4-32*x1^3+1032*x1^2+1576*x1+1549, -z1^2 - 3*x1^2 - 6],
< <41,"[x1,-y1,z1]">, <82, "[x1,y1,-z1]"> >,
41
>,
<
86,
...
< <4,"[-x1,-y1,-z1]">, <3,"[x1,y1,-z1]">, <5,"[x1,-y1,-z1]"> >,
15
>,
<
21,
