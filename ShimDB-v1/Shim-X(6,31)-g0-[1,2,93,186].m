...
s`ShimLabel := "6.31-[1,2,93,186]";

s`ShimDiscriminant :=  6;
s`ShimLevel :=  31;
s`ShimAtkinLehner :=  [ 1, 2, 93, 186 ];
s`ShimGenus :=  0;
...
-1/6*x[1]^7*x[3] - 2/3*x[1]^5*x[3]^3 - 2*x[1]^3*x[3]^5 - 9/2*x[1]*x[3]^7,
-x[1]^8 - 4*x[1]^6*x[3]^2 - 21*x[1]^4*x[3]^4 - 36*x[1]^2*x[3]^6 - 81*x[3]^8
] >;
return s;
