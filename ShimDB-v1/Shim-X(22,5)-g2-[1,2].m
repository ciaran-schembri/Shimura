...
s`ShimModel := HyperellipticCurve([Polynomial([RationalField() | -1, -1, -7, -3, -7, -1, -1]), Polynomial([RationalField() | 0, 1, 1])]);
...
-1/8*x[1]^5*x[3]^13 - 1/8*x[1]^3*x[3]^15 - 1/8*x[1]*x[3]^17 - 1/8*x[2]*x[3]^12,
1/2*x[1]^2*x[3]^4 - 1/2*x[1]*x[3]^5 + 1/2*x[3]^6
] >;
return s;
